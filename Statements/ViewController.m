...
- (void)viewDidLoad
{
    ...
    //add shadow img
    CGRect pieFrame = CGRectMake((SCREENSIZE.width - PIE_HEIGHT) / 2, 80-0, PIE_HEIGHT, PIE_HEIGHT);
...
//    [self.view addSubview:shadowImgView];
    ...
    selView.frame = CGRectMake((SCREENSIZE.width - selView.image.size.width/2)/2, self.pieContainer.frame.origin.y + self.pieContainer.frame.size.height, selView.image.size.width/2, selView.image.size.height/2);
